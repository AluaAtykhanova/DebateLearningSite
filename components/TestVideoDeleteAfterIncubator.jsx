...
const Video = () => (
  <div className="mx-auto max-w-7xl" style={{ color: 'white', minHeight: '100vh' }}>
    <div className="px-4 py-8 mx-auto max-w-screen-xl">
      ...
      <div className={(typeof window === 'undefined' ? 500 : window.innerWidth) >= 900 ? 'mt-8 grid grid-cols-5 gap-4' : 'mt-8 grid-cols-2 md:flex gap-4'}>
        ...
        <div className="bg-gray-800 p-4 rounded-md">
          <img
            ...
            className="w-full h-auto rounded-md"
          />
          <h3 className="text-xl mb-2">Видео 5</h3>
        </div>
      </div>
    </div>
  </div>
